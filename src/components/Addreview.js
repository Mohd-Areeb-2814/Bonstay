...
const Addreview = () => {
  ...
  let [hotelToBeUpdated, setHotelToBeUpdated] = useState({
    id: 0,
    hotelName: "",
    city: "",
    description: "",
  ...
  useEffect(() => {
    if (hotelToBeUpdated.id === 0) {
      axios
        .get("http://localhost:4000/hotels/" + hotelId)
        .then((response) => {
    ...
    if (state.reviews !== "") {
      if (valid && !mandatory) {
        axios
          .put(`http://localhost:4000/hotels/${hotelId}`, hotelToBeUpdated)
          .then((response) => {
  ...
  const handleSubmit = (event) => {
    ...
    if (valid) {
      ...
      setHotelToBeUpdated((prevState) => ({
        ...prevState,
        reviews: [...prevState.reviews, state.reviews],
      }));
    }
  };
      ...
      <div>
        ...
        >
          <div className="row p-3">
            ...
            <div
              className="col-lg-6"
              style={{ backgroundColor: "#ebe7e7", width: "59%" }}
            >
              <form
              ...
              >
                ...
                */}
                ...
                <div className="mb-2 mt-2">
                   ...
                   */}
                  {formErrors.reviews ? (
                    <span className="text-danger">{formErrors.reviews}</span>
                  ) : null}
                </div>
                <br />
